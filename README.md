...
Ответ отдельно показывает количество SKU и физический остаток, свежесть поколения, предложения поставщиков и неизвестные характеристики. Повреждённые или несогласованные поколения не активируются; при допустимом fallback устаревание отмечается как `stale_cache`.
